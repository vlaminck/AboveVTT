...
function init_splash() {
	...
	cont.append("<h1 style='padding-bottom:2px;margin-bottom:2px; text-align:center'><img width='250px' src='" + window.EXTENSION_PATH + "assets/logo.png'><div style='margin-left:20px; display:inline;vertical-align:bottom;'>0.63</div></h1>");
	...
	cont.append("<br>Contributors: <b>Stumpy, Palad1N, KuzKuz, Coryphon, Johnno, Hypergig, JoshBrodieNZ, Kudolpf, Koals, Mikedave, Jupi Taru, Limping Ninja, Turtle_stew, Etus12, Cyelis1224</b>");
	...
	l1 = ["Max Puplett","Jordan Cohen","Epyk","ZorkFox","Zytiga Gaming","Josh Downing","John Curran","Nathan Wilhelm","The Dread Pirate Mittens","Dennis Andree","Mike Miller"];
	l2 = ["Iain Russell","Lukas Edelmann","Oliver","Jordan Innerarity","Phillip Geurtz","Virginia Lancianese","Daniel Levitus","RenoGeek","TheDigifire","Ryan Purcell","adam williams","Drago Russo","Kris Scott","Brendan Shane","Pucas McDookie","Chris Johnson","Elmer Senson","Chris Cannon","Tom","Carl Cedarstaff II","Kim Dargeou","Scott Moore","Starving Actor","Kurt Piersol","Joaquin Atwood-Ward","Tittus","Rooster","Michael Palm","Robert Henry","Cynthia Complese","Blaine Landowski","Cameron Patterson","Joe King","Rodrigo Carril"];
	l3 = ["Daniel Wall","Cameron Warner","Martin Brandt","Julia Hoffmann","Amata (she_her)","Alexander Engel","Fini Plays","Tommy Girouard-Belhumeur","nategonz","Jason Osterbind","Daniel Villablanca","William Geisbert","Adam Nothnagel","Miguel  Garcia Jr.","Kat","Cobalt Blue","Cody Vegas Rothwell","damian tier","CraftyHobo","CrazyPitesh","Milkmann","aaron hamilton","Eduardo Villela","Paul Maloney","David Meese","Adam Connor","mad4ever","Johan Surac","Chris Sells","Sarah (ExpQuest)","Aviad Tal","Randy Zuendel","Invictus92","Robert J Correa","Jon Bond","Cistern","James Cohen","its Bonez","BelowtheDM","Unlucky Archer","Michael Crane","Alexander Glass","Steve Vlaminck","Blake Thomas","Joseph Bendickson","Cheeky Sausage Games","Jerry Jones","David Hollenbeck","Kevin Young","aDingoAteMyBaby","Rennie","William Clem","Chris Meece","Victor Martinez","Ian Leyco","Michael Gisby","Dorian Arcos","Arish Rustomji","Christian Johansson","Gregory Willis","Kat Wells","DH Ford","Dirk Wynkoop","Michael Augusteijn","Jake Tiffany","LegalMegumin","Nicholas Phillips","Don Walton","Squirrel666Zmbi","Patrick Wolfer","Garry Rose","Wilko Rauert","Alexander Klein","Mage","Dee Rivers","Robert Sanderson","Michael Huffman","Rennan Whittington","Åsmund Gravem","Joseph Pecor","Bjscuba135","Erik Wilson","Luke Young","Scott Ganz","Brian Gabin","Rojo","ajay","Michael Micco","Michael Boughey","Mischa","AnyxKrypt","Abdullah","Kyle Kroeker","Keith Richard-Thompson","Torben Schwank","Unix Wizard","Angga Kramadibrata","Matt Oz"];
